...
I am looking for a small, testable first contribution in Python, especially a
bug fix or test/fixture correction with a clear reproduction and a narrow file
surface. I prefer issues that can be understood and verified locally without
large infrastructure changes, and I want to build confidence with API,
validation, and parser behavior. I am avoiding broad refactors, multi-service
features, and issues whose expected behavior is still under design.
